...
**Live:** https://ruwhitehead.github.io/grove/
...
- **Share cards** — canvas-rendered 1080×1080 posters via the Web Share API, carrying the Grove × ITF lockup
...
No runtime dependencies. Deploys to GitHub Pages via Actions (`BASE_PATH=/grove`); designed to move to
...
npm run build      # production build (BASE_PATH=/grove for Pages)
